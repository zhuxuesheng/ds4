...
xeon-down-test:
	$(CC) $(CFLAGS) -mprefer-vector-width=512 -fopenmp -o tests/ds4_xeon_down_test tests/ds4_xeon_down_test.c ds4_xeon.c -lm
	./tests/ds4_xeon_down_test
...
xeon-decode-bench:
	$(CC) $(CFLAGS) -mprefer-vector-width=512 -fopenmp -o tests/ds4_xeon_decode_bench tests/ds4_xeon_decode_bench.c ds4_xeon.c $(LDLIBS)
	./tests/ds4_xeon_decode_bench
